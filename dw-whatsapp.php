 ...
 * Description: Adiciona botões de WhatsApp ao WooCommerce com suporte a variações de produtos, botão flutuante e orçamentos para produtos sem preço.
 * Version: 0.1.0
...
define( 'DW_WHATSAPP_VERSION', '0.1.0' );
